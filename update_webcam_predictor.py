...
class BodyMeasurementPredictor:
    """Real-time body measurement prediction from webcam with AWS-trained model"""
    
    def __init__(self, model_path=None):
        # Try different model paths
        possible_models = [
            "bodym_real_model.h5",  # AWS-trained model
    ...
    def _load_model(self):
        ...
        try:
            ...
            # Display model info
            if "real" in self.model_path.lower():
    ...
    def display_results(self, measurements):
        ...
        # Model info
        model_type = "AWS BodyM" if "real" in self.model_path.lower() else "Synthetic"
